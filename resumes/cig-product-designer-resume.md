...
Product Designer - B2B Tools & Digital Operations

mohdhayaat1@outlook.com | +91-7991880020 | +91-7905194153 | Delhi, India | Open to relocate to Dubai, UAE | [Portfolio](https://workofhayaat.framer.website)

## Professional Summary

Product Designer with 4+ years designing shipped mobile, web, transactional, and operations-heavy products. Strong fit for UAE corporate-services, business setup, and digital operations teams where users need clear onboarding, verification, payments, dashboards, task flows, and service-status visibility. Recent work includes wallet/payment UX that reduced transaction errors by 38%, multi-wallet delegation with spend limits, and B2B operations dashboards across India and Dubai workflows.
...
**B2B Operations UX:** Dashboards, fleet workflows, driver apps, scheduling systems, task flows, Gantt-style planning views, operational visibility, admin tools

**Corporate Service Flows:** Onboarding, KYC flows, verification journeys, service-status visibility, user roles, approvals, account setup, error handling

**Transactional UX:** Wallet flows, payment UX, transaction-error reduction, spend limits, delegated wallet access, high-trust workflows

**Product Design:** Mobile and web UX, interaction design, visual design, information architecture, wireframing, high-fidelity UI, responsive UI

**Research & Analytics:** User interviews, usability testing, A/B testing, journey mapping, funnel analysis, Google Analytics, Hotjar

**Design Systems & Delivery:** Figma components, Auto Layout, component libraries, design documentation, developer handoff, agile collaboration

**Tools:** Figma, FigJam, Miro, Adobe Creative Suite, Rive, Framer

## Education

**BBA, Business Administration** | Sam Higginbottom University of Agriculture, Technology & Sciences | 2017 - 2020
