...
OUT = Path(r"C:\Users\mohdh\Documents\Job Hunt\resumes\Mohd_Hayaat_Ali_Product_Designer_UAE_Agencies.pdf")
...
styles.add(ParagraphStyle(name="ResumeBody", parent=styles["Normal"], fontName="Helvetica", fontSize=8.25, leading=10.65, textColor=colors.HexColor("#242424"), spaceAfter=4))
styles.add(ParagraphStyle(name="ResumeBullet", parent=styles["Normal"], fontName="Helvetica", fontSize=7.95, leading=10.25, textColor=colors.HexColor("#242424")))
...
story = [
    ...
    Paragraph("Product Designer with 4+ years designing shipped mobile, web, SaaS, fintech-adjacent, marketplace, and B2B operational products. Experienced in wallet and payment UX, KYC/onboarding, conversion optimisation, design systems, usability testing, dashboards, and developer handoff. Recent work includes reducing transaction errors by 38%, improving order completion from 62% to 78%, and designing multi-wallet delegation with spend limits for fleet and business users. Available for UAE/GCC product design roles.", styles["ResumeBody"]),
