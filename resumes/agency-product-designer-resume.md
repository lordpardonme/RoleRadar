...
Product Designer with 4+ years designing shipped mobile, web, SaaS, fintech-adjacent, marketplace, and B2B operational products. Experienced in wallet and payment UX, KYC/onboarding, conversion optimisation, design systems, usability testing, dashboards, and developer handoff. Recent work includes reducing transaction errors by 38%, improving order completion from 62% to 78%, and designing multi-wallet delegation with spend limits for fleet and business users. Available for UAE/GCC product design roles.
...
**Fintech & Transactional UX:** Wallet flows, payment UX, transaction-error reduction, spend limits, delegated wallet access, KYC flows, high-trust user journeys
