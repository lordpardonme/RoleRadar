...
OUT = Path(r"C:\Users\mohdh\Documents\Job Hunt\resumes\Mohd_Hayaat_Ali_Product_Designer_BAC_Middle_East.pdf")
...
styles.add(ParagraphStyle(name="ResumeBody", parent=styles["Normal"], fontName="Helvetica", fontSize=8.15, leading=10.55, textColor=colors.HexColor("#242424"), spaceAfter=4))
styles.add(ParagraphStyle(name="ResumeBullet", parent=styles["Normal"], fontName="Helvetica", fontSize=7.85, leading=10.15, textColor=colors.HexColor("#242424")))
...
story = [
    ...
    Paragraph("Product Designer with 4+ years across mobile, web, SaaS, fintech-adjacent, marketplace, healthcare, logistics, and B2B operational products. Built shipped UX for consumer apps and internal platforms, including wallet/payment flows, KYC/onboarding, dashboards, scheduling, booking journeys, and design systems. Recent results include reducing transaction errors by 38%, improving order completion from 62% to 78%, and increasing booking completion from 71% to 83%. Available for UAE/GCC product, UI/UX, digital transformation, and SaaS design roles.", styles["ResumeBody"]),
...
story.extend([
    ...
    Paragraph("<b>Product Design:</b> Mobile and web UX, end-to-end product design, interaction design, visual design, information architecture, wireframing, high-fidelity UI<br/><b>Digital Transformation & Operations:</b> Dashboards, B2B tools, fleet workflows, scheduling systems, task flows, internal platforms, developer handoff<br/><b>Fintech & Transactional UX:</b> Wallet flows, payment UX, transaction-error reduction, spend limits, delegated wallet access, KYC flows<br/><b>Research & Analytics:</b> UX research, user interviews, usability testing, A/B testing, journey mapping, funnel analysis, Google Analytics, Hotjar<br/><b>Design Systems:</b> Figma components, Auto Layout, component libraries, responsive UI patterns, design documentation<br/><b>Domains:</b> Consumer apps, SaaS, fintech, marketplaces, healthcare, logistics, B2B operations, fleet management<br/><b>Tools:</b> Figma, FigJam, Miro, Adobe Creative Suite, Rive, Framer", styles["ResumeBody"]),
