...
Product Designer with 4+ years across mobile, web, SaaS, fintech-adjacent, marketplace, healthcare, logistics, and B2B operational products. Built shipped UX for consumer apps and internal platforms, including wallet/payment flows, KYC/onboarding, dashboards, scheduling, booking journeys, and design systems. Recent results include reducing transaction errors by 38%, improving order completion from 62% to 78%, and increasing booking completion from 71% to 83%. Available for UAE/GCC product, UI/UX, digital transformation, and SaaS design roles.
...
**Product Design:** Mobile and web UX, end-to-end product design, interaction design, visual design, information architecture, wireframing, high-fidelity UI

**Digital Transformation & Operations:** Dashboards, B2B tools, fleet workflows, scheduling systems, task flows, internal platforms, developer handoff

**Fintech & Transactional UX:** Wallet flows, payment UX, transaction-error reduction, spend limits, delegated wallet access, KYC flows

**Research & Analytics:** UX research, user interviews, usability testing, A/B testing, journey mapping, funnel analysis, Google Analytics, Hotjar

**Design Systems:** Figma components, Auto Layout, component libraries, responsive UI patterns, design documentation

**Domains:** Consumer apps, SaaS, fintech, marketplaces, healthcare, logistics, B2B operations, fleet management
