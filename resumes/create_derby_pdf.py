...
OUT = Path(r"C:\Users\mohdh\Documents\Job Hunt\resumes\Mohd_Hayaat_Ali_Product_Designer_Derby_Group.pdf")
...
jobs = [
    ("Product Designer", "FuelBuddy | Gurgaon, India | 07/2023 - 06/2024", [
        "Designed wallet and payment-system UX improvements that reduced transaction errors by 38%, improving reliability across customer and operational payment workflows.",
...
story = [
    ...
    Paragraph("Product Designer - Outsourcing, CX & Service Operations", styles["ResumeTitle"]),
    ...
    Paragraph("Product Designer with 4+ years designing shipped mobile, web, transactional, and operations-heavy products. Strong fit for UAE outsourcing, BPO, customer-operations, banking-support, and service-delivery teams where users need clear onboarding, verification, payments, dashboards, task tracking, and operational visibility. Recent work includes wallet/payment UX that reduced transaction errors by 38%, multi-user wallet delegation with spend limits, and B2B operations dashboards used across India and Dubai workflows.", styles["ResumeBody"]),
...
story.extend([
    ...
    Paragraph("<b>Customer Operations UX:</b> Service workflows, task flows, ticket-reduction UX, operational visibility, dashboard design, workflow clarity, role-based access<br/><b>Outsourcing &amp; BPO Systems:</b> Admin tools, support operations, verification journeys, process handoffs, SLA-sensitive flows, status tracking, multi-step workflows<br/><b>Transactional &amp; Trust UX:</b> Wallet flows, payment UX, transaction-error reduction, KYC flows, spend limits, delegated access, high-trust workflows<br/><b>Product Design:</b> Mobile and web UX, interaction design, visual design, information architecture, wireframing, high-fidelity UI, responsive UI<br/><b>Research &amp; Analytics:</b> User interviews, usability testing, A/B testing, journey mapping, funnel analysis, Google Analytics, Hotjar<br/><b>Design Systems &amp; Delivery:</b> Figma components, Auto Layout, component libraries, design documentation, developer handoff, agile collaboration<br/><b>Tools:</b> Figma, FigJam, Miro, Adobe Creative Suite, Rive, Framer", styles["ResumeBody"]),
